...
with open('day21.txt', 'r') as f:
    ...
    # Find which ingredients cannot possibly contain a listed allergen
    allergen_free_count = sum(sum(1 for ingredient in ingredient_row if ingredient not in allergen_matches.values()) for (ingredient_row, allergen_row) in food_table)
